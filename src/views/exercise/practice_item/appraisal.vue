  ...
  <div>
    ...
    <van-dropdown-menu>
      <van-dropdown-item title="类型不限">
        ...
        <!-- <div class="one_option">全部</div>
        <div class="one_option">套装练习</div>
        <div class="one_option">仿真模考</div>
        <div class="one_option">考点专练</div> -->
      </van-dropdown-item>
      <van-dropdown-item title="时间">
        ...
        <!-- <div class="one_option">全部</div>
        <div class="one_option">今天</div>
        <div class="one_option">7天</div> -->
      </van-dropdown-item>
    </van-dropdown-menu>
