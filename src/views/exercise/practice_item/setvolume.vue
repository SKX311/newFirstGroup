        ...
        <el-row class="tac">
          <el-col :span="10">
            <el-menu
              ...
              active-text-color="#eb6100"
              background-color="#FAFAFA"
              @open="handleOpen"
              @close="handleClose"
            >
              <el-menu-item index="0" @click="go('/all')">
                <span class="SS" slot="title">全部</span>
              </el-menu-item>
              <el-menu-item index="1" @click="go('/senior')">
                <span class="SS" slot="title">中考真题</span>
              </el-menu-item>
              <el-menu-item index="2" @click="go('/sethx')">
                <span class="SS" slot="title">化学</span>
              </el-menu-item>
              <el-menu-item index="3" @click="go('/setenlinsh')">
                <span class="SS" slot="title">英语</span>
              </el-menu-item>
            </el-menu>
          </el-col>
